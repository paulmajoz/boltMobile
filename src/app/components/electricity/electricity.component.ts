...
//     private readonly headerRefreshService: HeaderRefreshService // ✅ Inject it
//   ) {}
...
//         this.headerRefreshService.triggerRefresh(); // ✅ Refresh header after token received
//         this.calculateAvailableLimit(); // Optional: update local limit display
//       } else {
